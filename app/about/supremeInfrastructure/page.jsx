    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="container mx-auto px-6 md:px-16 py-16">
                        ...
                        {directors.map((director, index) => (
                            ...
                            >
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    />
                                    <div className="p-6">
                                        <h3 className="text-lg font-semibold text-amber-700">{director.position}</h3>
                                        <p className="text-xl font-medium text-gray-800">{director.name}</p>
                                        <p className="text-gray-600 mt-2">{director.bio}</p>
                                        <Link href="#" className="inline-flex items-center text-amber-600 hover:text-blue-700 mt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {services.map((service, index) => (
                            <motion.div
                                ...
                                whileHover={{ scale: 1.05 }}
                            >
                                <div className="text-5xl mb-4 text-amber-600 mx-auto">{service.icon}</div>
                ...
                {/* Stats Section */}
                <section className="mb-20 bg-gradient-to-r from-amber-600 to-amber-700 text-white py-16 rounded-lg text-center">
